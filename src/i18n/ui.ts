...
export const ui = {
  en: {
    ...
    "whyAttend.description":
      "The decision to come to Australia to study is exciting, but choosing the right schools is tough! Visit AEAS AUSTRALIAN SCHOOLS INFORMATION DAY and have a 1-on-1 consultation with interpreters available at every booth. This is a great opportunity to gather information and attend the free parent seminars. <br><br>Don't miss this chance to take the first step towards your Australian education adventure! Admission is free, join the AUSTRALIAN SCHOOLS INFORMATION DAY 2024 and start exploring your options today!",

    "school.title": "Schools Participants",
  ...
  km: {
    ...
    "whyAttend.description":
      "ការសម្រេចចិត្តឱ្យកូនមករៀននៅអូស្ត្រាលីគឺពិតជារភើប ប៉ុន្តែការជ្រើសរើសសាលាត្រឹមត្រូវគឺពិបាកណាស់! សូមអញ្ញើញចូលរួម AEAS ពិព័រណ៍ព័ត៌មានសាលានៅប្រទេសអូស្រ្តាលី ដែលនឹងមានអ្នកពិគ្រោះយោបល់ ១ ទល់នឹង ១ ថែមទាំងមានអ្នកបកប្រែសម្រាប់លោកអ្នកនៅគ្រប់ស្តង់ពិព័រណ៍។ នេះគឺជាឱកាសដ៏ល្អក្នុងការមកទទួលយកព័ត៌មាន និងចូលរួមសិក្ខាសាលាមាតាបិតាដោយឥតគិតថ្លៃ។ <br><br>កុំឱ្យឱកាសដ៏ល្អនេះកន្លងផុតទៅ សូមអញ្ញើញចូលរួមដោយសេរី ពិព័រណ៍ព័ត៌មានសាលានៅប្រទេសអូស្រ្តាលី ឆ្នាំ២០២៤ ហើយចាប់ផ្តើមធ្វើការសិក្សាស្វែងយល់ពីជម្រើសសម្រាប់កូនៗរបស់អ្នកនៅថ្ងៃនេះ!",

    "school.title": "សាលាដៃគូសហការណ៍",

    "aboutUs.title": "តើ AEAS គឺជាអ្វី?",
    "aboutUs.description":
